  ...
  pt: {
    ...
    schedule: {
      ...
      day1: [
        ...
        { time: '13:45 - 15:15', activity: 'Mesas Redondas Simultâneas', details: '• Neurofisiologia e comportamento motor (Mod: Prof. Dr. Jorge Oliveira)\n• Paradigmas clássicos do controle motor (Mod: Prof. Dr. Umberto Corrêa)\n• Interdependência do Desenvolvimento Motor e outros Domínios (Mod: Prof. Dr. Luciano Basso)\n• Aprendizagem Motora e Fatores Intervenientes (Mod: Prof. Dr. Flavio Bastos)' },
      ...
      day2: [
        ...
        { time: '10:00 - 10:30', activity: 'Coffee Break' },
        { time: '10:30 - 12:00', activity: 'Mesas Redondas Simultâneas', details: '• Avanços na relação entre Reabilitação e Comportamento Motor (Mod: Prof. Dr. Jorge Oliveira)\n• As bases do comportamento motor para formação e detecção de talentos no esporte (Mod: Prof. Dr. Umberto Correa)\n• Desenvolvimento Motor e Atividade Física (Mod: Prof. Dr. Luciano Basso)\n• A Intersecção entre Aprendizagem Motora e Desenvolvimento Motor (Mod: Prof. Dr. Flavio Bastos)' },
        { time: '12:00 - 13:15', activity: 'Almoço' },
        ...
        { time: '17:30 - 18:00', activity: 'Apresentação Cultural', details: 'Coral USP' },
        { time: '19:30', activity: 'Jantar do Evento', details: 'TBA' },
      ],
      day3: [
